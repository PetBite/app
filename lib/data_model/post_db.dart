...
class PostDB {
  final List<PostData> _posts = [
    PostData(
        ...
        content: 'I started feeding Snowflake a raw diet since the start of the year, and she\'s looking better than ever! Check out her transformation!',
        likesCount: 7,
        timestamp: '2:14 PM',
    ...
    PostData(
        ...
        content: 'If you\'re thinking about getting a new dog, I highly recommend a Shiba Inu. They\'re super cute and very loyal; it\'s like having your own Sana!',
        likesCount: 69,
        timestamp: '10:52 AM',
  ...
  List<String> getYourPostIDs() {
    return _posts.map((postData) => postData.authorID).where((authorID) => authorID == currentUserID).toList();
  }
}
